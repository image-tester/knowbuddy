...
Devise.setup do |config|
  ...
  # if you use your own mailer class with default "from" parameter.
  config.mailer_sender = "notifications@kiprosh.com"
  ...
  # be passed to the find_for_authentication method and considered in
  # your model lookup. For instance, if you set :request_keys to [:subdomain],
  ...
  # False by default. It can be set to an array that
  # will enable http authentication only for the given strategies,
  # for example, `config.http_authenticatable = [:token]` will
  ...
  # If using other encryptors, it sets how many times you want
  # the password re-encrypted.
  # Limiting the stretches to just one in testing will
  # increase the performance of your test suite dramatically.
  # However, it is STRONGLY RECOMMENDED to not use
  # a value less than 10 in other environments.
  config.stretches = Rails.env.test? ? 1 : 10

  # Setup a pepper to generate the encrypted password.
  # config.pepper = "a5e07a1219df0aca91f9c33eb41f14c3a858fd834305e467fef435db32
  # c5cfd18eaaba763a508afacda049a9c3aa61722a9c925c5bfc72df1f5b12adfa218aa1"
  ...
  # If true, requires any email changes to be confirmed (exctly the same way
  ...
  # attempts to sign in.
  # :none            = No lock strategy. You should handle
  # locking by yourself.
  ...
  # or encryptors from others authentication tools as :clearance_sha1,
  # :authlogic_sha512 (then you should set stretches above to 20 for
  # default behavior) and :restful_authentication_sha1
  ...
  # Sign_out action can be scoped
  # (i.e. /users/sign_out affects only :user scope).
  # The default is true, which means any logout action
  # will sign out all active scopes.
